...
- **[Submit new GLIPH project](http://50.255.35.37:8080/project)**
  ...
  - Add new project
    ...
    ![](../img/gliph_submission_1.jpg)
   
  - Input project parameters
  
    ![](../img/gliph_submission_2.jpg)

- GLIPH2 will run in the background. Periodically check the project tab to see if your project is complete, then click download
